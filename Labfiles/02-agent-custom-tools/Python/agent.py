...
def main(): 
    ...
    with(
        ...
        input_list : ResponseInputItemParam = []
        ...
        while True:
            ...
            for item in response.output:
                if item.type == "function_call":
                    ...
                    # Queue the function's result, tagged with call_id so the model can match it to its function_call request
                    input_list.append(
                        FunctionCallOutput(
        ...
        # Remove this specific agent version so it doesn't persist in the project after the script exits
